    ...
    (window.Alpine.data("cveModal", t),
      window.Alpine.data("vulnDashboard", () => ({
        ...
        applyFilters() {
          ...
          const s = this.filters.publishedDateFrom || this.filters.dateFrom;
          if (s) {
            const e = new Date(s);
            t = t.filter((t) => new Date(t.publishedDate) >= e);
          }
          const i = this.filters.publishedDateTo || this.filters.dateTo;
          if (i) {
            const e = new Date(i);
            (e.setHours(23, 59, 59, 999), (t = t.filter((t) => new Date(t.publishedDate) <= e)));
          }
          if (this.filters.lastModifiedDateFrom) {
            const e = new Date(this.filters.lastModifiedDateFrom);
            t = t.filter((t) => new Date(t.lastModifiedDate) >= e);
          }
          if (this.filters.lastModifiedDateTo) {
            const e = new Date(this.filters.lastModifiedDateTo);
            (e.setHours(23, 59, 59, 999), (t = t.filter((t) => new Date(t.lastModifiedDate) <= e)));
          }
        ...
        announceFilterResults() {
          ...
          const s = this.filters.publishedDateFrom || this.filters.dateFrom,
            i = this.filters.publishedDateTo || this.filters.dateTo;
          if (s || i) {
            const e = s ? `from ${s}` : "",
              a = i ? `to ${i}` : "";
            t.push(`published ${e} ${a}`.trim());
          }
          if (this.filters.lastModifiedDateFrom || this.filters.lastModifiedDateTo) {
            const e = this.filters.lastModifiedDateFrom
                ? `from ${this.filters.lastModifiedDateFrom}`
                : "",
              s = this.filters.lastModifiedDateTo ? `to ${this.filters.lastModifiedDateTo}` : "";
            t.push(`last modified ${e} ${s}`.trim());
          }
          t.length > 0 && (e += ` with filters: ${t.join(", ")}`);
          let a = document.getElementById("filter-announcement");
          (a ||
            ((a = document.createElement("div")),
            (a.id = "filter-announcement"),
            (a.className = "sr-only"),
        ...
        validateFilters() {
          ...
          const t = this.filters.publishedDateFrom || this.filters.dateFrom,
            s = this.filters.publishedDateTo || this.filters.dateTo;
          return (
            t &&
              s &&
              new Date(t) > new Date(s) &&
              e.push("Published start date cannot be after end date"),
            this.filters.lastModifiedDateFrom &&
              this.filters.lastModifiedDateTo &&
              new Date(this.filters.lastModifiedDateFrom) >
                new Date(this.filters.lastModifiedDateTo) &&
              e.push("Last modified start date cannot be after end date"),
        ...
        sortResults(e) {
          ...
          return e.sort((e, i) => {
            ...
            return (
              ...
              "string" == typeof t &&
                t.includes("Date") &&
                ((a = new Date(a).getTime()), (r = new Date(r).getTime())),
              a < r ? ("asc" === s ? -1 : 1) : a > r ? ("asc" === s ? 1 : -1) : 0
            );
          });
        },
        sort(t) {
        ...
        loadStateFromHash() {
          ...
          ((this.searchQuery = t.get("q") ?? ""),
            ...
            (this.filters.publishedDateFrom = t.get("publishedDateFrom") ?? ""),
            (this.filters.publishedDateTo = t.get("publishedDateTo") ?? ""),
            (this.filters.lastModifiedDateFrom = t.get("lastModifiedDateFrom") ?? ""),
            (this.filters.lastModifiedDateTo = t.get("lastModifiedDateTo") ?? ""),
          ...
          ((this.filters.tags = s ? s.split(",").filter((e) => e) : []),
            ...
            (this.pageSize = parseInt(t.get("size") ?? "50")));
        },
        getSeverityClass: (e) =>
          e >= 9
            ? "severity-critical"
