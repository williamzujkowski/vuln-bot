      ...
      window.Alpine.data("vulnDashboard", () => ({
        ...
        applyFilters() {
          ...
          (this.filters.exploitationStatus &&
            (t = t.filter((e) => e.exploitationStatus === this.filters.exploitationStatus)),
        ...
        announceFilterResults() {
          ...
          (this.searchQuery && t.push(`matching "${this.searchQuery}"`),
            ...
            this.filters.exploitationStatus &&
              t.push(`exploitation: ${this.filters.exploitationStatus}`),
        ...
        loadStateFromHash() {
          ...
          ((this.searchQuery = t.get("q") ?? ""),
            ...
            (this.filters.exploitationStatus = t.get("exploitation") ?? ""));
          const s = t.get("tags");
          ((this.filters.tags = s ? s.split(",").filter((e) => e) : []),
            (this.sortField = t.get("sort") ?? "exploitationStatus"),
