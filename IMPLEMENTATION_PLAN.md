...
- [x] Implement CVEProject/cvelistV5 repository client
- [x] Parse CVE Record Format v5.0/5.1
- [x] Implement EPSS API client
- [x] Create unit tests for API clients
- [x] Add response caching logic

### Day 5: API Clients Part 2
- [x] Implement filtering for Critical/High severity only
- [x] Add EPSS score threshold filtering (>60%)
- [x] Focus on 2025+ CVEs only
- [x] Parse CISA-ADP container for KEV/SSVC data
