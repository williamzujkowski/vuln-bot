        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-3">
                    <a href="https://williamzujkowski.github.io/vuln-bot/" class="flex items-center space-x-3 hover:opacity-80 transition-opacity">
                ...
                <nav class="flex items-center space-x-2">
                    ...
                    <!-- Back to dashboard -->
                    <a href="https://williamzujkowski.github.io/vuln-bot/"
