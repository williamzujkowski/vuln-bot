...
class DepsDevClient:
    """Stub class for testing - actual functionality moved to DataEnrichmentAgent."""

    def __init__(self):
        self.rate_limit_delay = 0.2

    async def get_vulnerability_info(self, _cve_id):
        """Stub method."""
        return None

    async def get_package_info(self, _ecosystem, _name, _version):
        """Stub method."""
        return None

    def _encode_cve_id(self, cve_id):
        """Stub method."""
        return cve_id

    def _encode_package_name(self, name):
        """Stub method."""
